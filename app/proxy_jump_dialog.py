...
class ProxyJumpDialog(QDialog):
    def __init__(self, title: str):
        ...
        self.target_user_input.setPlaceholderText("Target User")
        ...
        self.jump_user_input.setPlaceholderText("Jump User")
        self.jump_user_input.setFixedWidth(80)
        self.jump_host_input = QLineEdit(default_proxy_jump.jump_host)
        self.jump_host_input.setPlaceholderText("Jump Host")
